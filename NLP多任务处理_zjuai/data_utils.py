...
def convert_sample_to_numerical(input_data, max_seq_len=512, max_response_len=128, truncate_first_turn=False,
                                is_test=False):
    ...
    truncate_type, new_context_ids_list = truncate_ids_list(context_ids_list, max_seq_len - max_response_len - 2,
...
if __name__ == '__main__':
    ...
    data_process_list = [
        [
            [
                ["./data/Dialog_train/weibo_train.txt", to_sample_for_weibo, False, False],
                ["./data/Dialog_train/douban_train.txt", to_sample_for_douban, False, False],
                ["./data/Dialog_train/LCCC_train.json", to_sample_for_lccc, False, False],
                ["./data/Dialog_train/duconv_train.txt", to_sample_for_duconv, True, False],
                ["./data/Dialog_train/kdconv_train.txt", to_sample_for_kdconv, True, False],
                ["./data/Dialog_train/tencent_train.txt", to_sample_for_tencent, True, False],
                ["./data/Dialog_train/DuRecDial_train.txt", to_sample_for_durecdial, True, False],
                ["./data/Dialog_train/Persona_train.json", to_sample_for_persona, True, False],
                ["./data/Dialog_train/Emotional_train.txt", to_sample_for_emotional, True, False]
            ],
        ...
        [
            [
                ["./data/Dialog_dev/weibo_dev.txt", to_sample_for_weibo, False, False],
                ["./data/Dialog_dev/douban_dev.txt", to_sample_for_douban, False, False],
                ["./data/Dialog_dev/LCCC_dev.json", to_sample_for_lccc, False, False],
                ["./data/Dialog_dev/duconv_dev.txt", to_sample_for_duconv, True, False],
                ["./data/Dialog_dev/kdconv_dev.txt", to_sample_for_kdconv, True, False],
                ["./data/Dialog_dev/tencent_dev.txt", to_sample_for_tencent, True, False],
                ["./data/Dialog_dev/DuRecDial_dev.txt", to_sample_for_durecdial, True, False],
                ["./data/Dialog_dev/Persona_dev.json", to_sample_for_persona, True, False],
                ["./data/Dialog_dev/Emotional_dev.txt", to_sample_for_emotional, True, False]
            ],
            "./data/target/dev.txt",
            5000,
        ],
        [
            [
                ["./data/Dialog_testA/duconv_test.txt", to_sample_for_duconv, True, True],
                ["./data/Dialog_testA/DuRecDial_test.txt", to_sample_for_durecdial, True, True],
                ["./data/Dialog_testA/Persona_test.json", to_sample_for_persona, True, True],
            ],
            "./data/target/testA.txt",
            0
        ],
        [
            [
                ["./data/Dialog_testB/duconv_testB.txt", to_sample_for_duconv, True, True],
                ["./data/Dialog_testB/DuRecDial_testB.txt", to_sample_for_durecdial, True, True],
                ["./data/Dialog_testB/Persona_testB.json", to_sample_for_persona, True, True],
            ],
            "./data/target/testB.txt",
            0
        ],
    ]
    ...
    for [input_list, output_file, TRAIN_SAMPLE_NUM_THRESHOLD] in data_process_list:
        ...
        T = truncate_type_stat[0] + truncate_type_stat[1] + truncate_type_stat[2] + truncate_type_stat[3] + \
            truncate_type_stat[4]
        FT = float(T)
...
#python data_utils.py spm.model
